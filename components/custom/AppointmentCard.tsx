                ...
                <div className="flex gap-2">
                    ...
                    <div className="flex-1">
                        <div className="flex justify-between items-start">
                            ...
                            <Badge className={`${statusColors[status || "Confirmed"]} text-[8px] px-1.5 py-0.5`}>
                                {status}
                            </Badge>
                        </div>
                        ...
                        <div className="flex items-center gap-2 text-[10px] mt-1">
                            ...
                            <Badge
                                variant="outline"
                                className={`text-[8px] px-1 flex items-center gap-0.5 ${typeColors[appointmentType || "Video"]}`}
                            >
