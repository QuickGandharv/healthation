...
export default function Appointments() {
  ...
  const appointments: Appointment[] = [
    {
      ...
      duration: "30 min",
      type: "video",
      reason: "Follow-up Consultation - Patient requested to discuss recent lab results",
      status: "confirmed",
      ...
      chiefComplaint: "Patient reports persistent headaches and elevated blood pressure readings at home. Wants to discuss medication adjustment and lifestyle changes.",
      medicalHistory: "Hypertension diagnosed 5 years ago. Currently on Lisinopril 10mg daily. No known allergies. Family history of heart disease.",
      medications: [
        { name: "Lisinopril", dosage: "10mg", frequency: "Once daily", prescribed: "2026-01-15" },
        { name: "Aspirin", dosage: "81mg", frequency: "Once daily", prescribed: "2026-01-15" }
      ],
      vitals: {
      ...
      labResults: [
        ...
        { name: "Lipid Panel", date: "2026-03-10", status: "abnormal", notes: "Cholesterol slightly elevated" },
    ...
    },
    {
      ...
      duration: "45 min",
      type: "phone",
      reason: "Lab Results Discussion - Review blood test results and next steps",
      status: "confirmed",
      ...
      chiefComplaint: "Patient wants to discuss recent blood work results including cholesterol levels and thyroid function tests.",
      medicalHistory: "Hypothyroidism on Synthroid 50mcg. Family history of high cholesterol. Allergic to penicillin.",
      medications: [
        { name: "Synthroid", dosage: "50mcg", frequency: "Once daily", prescribed: "2025-11-20" },
        { name: "Vitamin D", dosage: "2000 IU", frequency: "Once daily", prescribed: "2025-11-20" }
      ],
      vitals: {
      ...
      labResults: [
        ...
        { name: "Lipid Panel", date: "2026-03-09", status: "abnormal", notes: "LDL cholesterol high" }
      ],
      appointments: [
        { date: "2026-03-11", type: "Phone Consultation", doctor: "Dr. Sarah Johnson" },
    ...
    },
    {
      ...
      duration: "60 min",
      type: "video",
      reason: "Initial Consultation - New patient comprehensive assessment needed",
      status: "pending",
      ...
      chiefComplaint: "New patient seeking comprehensive evaluation for ongoing fatigue and occasional chest discomfort.",
      medicalHistory: "No significant past medical history. Occasional heartburn. No known allergies.",
      medications: [],
      vitals: {
    ...
    },
    {
      ...
      chiefComplaint: "Routine medication review for hypertension. Patient reports good blood pressure control with current medications.",
      medicalHistory: "Hypertension for 8 years. Type 2 diabetes diagnosed 3 years ago. No known allergies.",
      medications: [
        { name: "Lisinopril", dosage: "20mg", frequency: "Once daily", prescribed: "2026-02-01" },
        { name: "Metformin", dosage: "500mg", frequency: "Twice daily", prescribed: "2026-02-01" }
      ],
      vitals: {
    ...
    },
    {
      ...
      chiefComplaint: "Annual physical examination. No specific complaints but wants general health assessment.",
      medicalHistory: "High cholesterol. Takes statin medication. No known allergies.",
      medications: [
        { name: "Atorvastatin", dosage: "20mg", frequency: "Once daily", prescribed: "2025-10-15" }
      ],
      vitals: {
    ...
    },
    {
      ...
      chiefComplaint: "Follow-up after laparoscopic cholecystectomy performed 2 weeks ago. Reports good recovery with minimal pain.",
      medicalHistory: "Gallstones. Surgery on 02/24/2026. No known allergies.",
      medications: [
        { name: "Ibuprofen", dosage: "400mg", frequency: "As needed", prescribed: "2026-02-24" }
      ],
      vitals: {
    ...
    },
    {
      ...
      chiefComplaint: "Initial consultation for back pain. Patient cancelled due to scheduling conflict.",
      medicalHistory: "Chronic lower back pain. Occasional muscle spasms.",
      medications: [
        { name: "Ibuprofen", dosage: "400mg", frequency: "As needed", prescribed: "2026-01-10" }
      ],
      vitals: {
    ...
    },
    {
      ...
      chiefComplaint: "Annual wellness visit. No active complaints. Feels healthy.",
      medicalHistory: "No significant medical history. No medications. No known allergies.",
      medications: [],
      vitals: {
    ...
    },
    {
      ...
      chiefComplaint: "Follow-up for hypertension. Home BP readings averaging 135/85. Wants to discuss medication adjustment.",
      medicalHistory: "Hypertension for 12 years. High cholesterol. Takes Lisinopril and Atorvastatin.",
      medications: [
        { name: "Lisinopril", dosage: "20mg", frequency: "Once daily", prescribed: "2025-12-01" },
        { name: "Atorvastatin", dosage: "40mg", frequency: "Once daily", prescribed: "2025-12-01" }
      ],
      vitals: {
      ...
      labResults: [
        { name: "Lipid Panel", date: "2026-03-05", status: "abnormal", notes: "LDL slightly elevated" }
      ],
      appointments: [
    ...
    },
    {
      ...
      chiefComplaint: "Medication review for anxiety. Appointment cancelled due to family emergency.",
      medicalHistory: "Generalized anxiety disorder. Takes Sertraline.",
      medications: [
        { name: "Sertraline", dosage: "50mg", frequency: "Once daily", prescribed: "2026-01-20" }
      ],
      vitals: {
    ...
    },
    {
      ...
      chiefComplaint: "New patient seeking evaluation for fatigue and occasional dizziness. Symptoms have been present for 3 months.",
      medicalHistory: "No significant past medical history. Occasional heartburn. No known allergies.",
      medications: [],
      vitals: {
        bloodPressure: "118/76",
      ...
      labResults: [
        ...
        { name: "Comprehensive Metabolic Panel", date: "2026-03-05", status: "normal" }
      ],
      appointments: [
    ...
    },
    {
      ...
      chiefComplaint: "Follow-up after completing physical therapy for rotator cuff injury. Reports significant improvement in shoulder mobility and reduced pain.",
      medicalHistory: "Rotator cuff injury diagnosed 3 months ago. Completed 8 weeks of PT. No known allergies.",
      medications: [
        { name: "Naproxen", dosage: "220mg", frequency: "As needed", prescribed: "2025-12-10" }
      ],
      vitals: {
        bloodPressure: "122/78",
        heartRate: "70",
  ...
  const getFilteredAppointments = () => {
    ...
    if (selectedType === "in-person") {
      ...
      filtered = filtered.filter(apt => apt.type === "video" || apt.type === "phone");
    }
        ...
        <TabsContent value="all" className="space-y-6 mt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
            {paginatedAll.map((appointment) => (
              <Card
                key={appointment.id}
                className="border border-gray-200 rounded-xl hover:shadow-md transition cursor-pointer hover:border-primary/50"
                onClick={() => {
                  try {
                    // ✅ Proper encoding
                    const dataString = encodeURIComponent(JSON.stringify(appointment));
              ...
              >
                <CardContent className="p-5">
                  ...
                  <div className="flex gap-3" onClick={(e) => e.stopPropagation()}> {/* ✅ Prevent card click */}
                    <Button
                      size="sm"
