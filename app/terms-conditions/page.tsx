...
const Page = () => {
  ...
  const termsData = data?.term_and_conditions;
          ...
          <div className="p-6 md:p-8 lg:p-10">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center py-12">
                ...
                <p className="mt-4 text-sm text-gray-500">Loading terms and conditions...</p>
              </div>
            ) : error ? (
              <EmptyState
              ...
              />
            ) : !termsData || termsData.trim() === "" ? (
              <EmptyState
                title="No Terms & Conditions Available"
                message="The terms and conditions are currently not available. Please check back later or contact support for more information."
