...
//     const { data } = await api.get(`${doctorID}`, {
//         params: { group },
//         signal,
//     });
//     return data;
...
//     const { data } = await api.post(`${doctorID}`, finalPayload, {
//         headers: {
...
import api from "@/lib/axios";
import { DoctorProfileGroup, DoctorProfileResponse } from "@/types/doctor/profile";
